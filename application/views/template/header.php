                            ...
                            <li class="<?php if($nav_report_active) echo 'active';?> treeview <?php if($this->session->userdata('u_role') != '02') echo 'hide'; ?>">
                                <a href="#">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="<?php if($nav_report_student_active) echo 'active'; ?>" ><a href="<?php echo site_url('Report/display_student_report'); ?>"><i class="fa fa-circle-o"></i>Student</a></li>
                                        <li class="<?php if($nav_report_course_active) echo 'active'; ?>"><a href="<?php echo site_url('Report/display_class_report'); ?>"><i class="fa fa-circle-o"></i>Course</a></li>
                                    </ul>
                                </a>
                            </li>
