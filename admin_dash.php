              ...
              <a href="#">
                <i class="fa fa-files-o"></i><span>Report</span><i class="fa fa-angle-left pull-right"></i>
                  <ul class="treeview-menu">
                    <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Each Student</a></li>
                    <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Each Section</a></li>
                    <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Each Class</a></li>
                  </ul>
              </a>
            </li>
            <li class="treeview">
